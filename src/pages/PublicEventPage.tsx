...
export function PublicEventPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Event Header */}
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow-lg overflow-hidden border border-gray-200 dark:border-slate-800">
        ...
        <div className="px-6 py-6">
          {/* Description */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-4">About This Event</h2>
            <p className="text-gray-700 dark:text-slate-300 leading-relaxed">{event.description}</p>
          </div>
          
          {/* Organizer */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-4">Organizer</h2>
            <div className="flex items-center">
              <img 
              ...
              />
              <div>
                <h3 className="font-medium text-gray-900 dark:text-slate-100">{event.organizer.name}</h3>
                <p className="text-gray-600 dark:text-slate-400">{event.organizer.title}</p>
              </div>
            </div>
          </div>
          ...
          {/* Agenda */}
          <div className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-4">Agenda</h2>
            <div className="space-y-3">
              {event.agenda.map((item, index) => (
                <div key={index} className="flex items-start">
                  ...
                  <div className="text-gray-700 dark:text-slate-300">{item.item}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100">Registration Status</h3>
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6 border border-gray-200 dark:border-slate-800">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">What to Bring</h3>
        ...
        <div className="bg-white dark:bg-slate-900 rounded-lg shadow p-6 border border-gray-200 dark:border-slate-800">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-slate-100 mb-4">Cancellation Policy</h3>
